  ...
  return (
    <footer className="footer">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-list">
            <li className="footer-contact-item">
              ...
              <span>+91 94437 42250, +91 90922 92256</span>
            </li>
            <li className="footer-contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="footer-icon">
              ...
              <span>vaadhyakalasathish@gmail.com</span>
            </li>
            <li className="footer-contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="footer-icon">
              ...
              <span>469, Balu Complex, Idayarpalayam Pirivu, Kuniyamuthur, Coimbatore 641008</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <p className="footer-text">© 2025 Sri Balamanikanda Vaadhya Kalakshethram, Coimbatore. All Rights Reserved.</p>
